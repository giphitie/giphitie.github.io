		...
		<React.Fragment>
					...
					<div className="row">
						<div className="col-md-12 text-center">
							<div className="giphitie-footer-social2  d-lg-none">
								<ul>
									<li>
										<a href="https://gitlab.com/giphitie" target="_blank" rel="nofollow noopener noreferrer" aria-label="GitLab">
			...
			<div className="giphitie-footer-social d-none d-lg-block" data-aos="fade-up" data-aos-delay="2200">
				<ul>
					...
					<li>
						<a href="https://twitter.com/giphitie" target="_blank" rel="nofollow noopener noreferrer" aria-label="Twitter">
							<span className="icon-twitter"></span>
						</a>
					</li>
				</ul>
