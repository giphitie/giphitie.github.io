 ...
 * @Last Modified time: 2020-11-06 22:19:53
 */
...
const Contact = () => {
    ...
    return (
        <section
            className="giphitie-section contact-section giphitie-no-pb"
            id="contact-section"
        >
                ...
                <div className="row d-flex contact-info mb-5">
                    ...
                    >
                        <div className="align-self-stretch box p-4 text-center">
                            ...
                            <p>
                                <a href="mailto:gifty18osei@gmail.com">
