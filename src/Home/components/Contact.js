 ...
 * @Last Modified time: 2020-07-20 05:49:53
 */
...
const Contact = () => {
	...
	const handleFormSubmit = async (event) => {
		...
		try {
			await axios.post('https://ddmailer.herokuapp.com/mails/oseigifty', { ...formState.values });
	...
	return (
		<section className='giphitie-section contact-section giphitie-no-pb' id='contact-section'>
				...
				<div className='row d-flex contact-info mb-5'>
					...
					<div className='col-md-6 col-lg-3 d-flex' data-aos='fade-up'>
						<div className='align-self-stretch box p-4 text-center'>
							...
							<p>
								<a href='tel://1234567920'>+233 55 475 1701</a>
							</p>
						</div>
					</div>
					<div className='col-md-6 col-lg-3 d-flex' data-aos='fade-up'>
						<div className='align-self-stretch box p-4 text-center'>
							...
							<p>
								<a href='mailto:gifty18osei@gmail.com'>gifty18osei@gmail.com</a>
							</p>
						</div>
					</div>
					<div className='col-md-6 col-lg-3 d-flex' data-aos='fade-up'>
						<div className='align-self-stretch box p-4 text-center'>
							...
							<p>
								<a href='https://oseigifty.com'>oseigifty.com</a>
							</p>
						</div>
					</div>
				</div>
