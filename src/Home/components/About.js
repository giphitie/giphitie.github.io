					...
					<div className="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div className="row justify-content-start pb-3">
							<div className="col-md-12 heading-section " data-aos="fade-up">
								...
								<p>
									I am a student with experience in teaching and programming based in Kumasi. My background in programming inform my
									mindful but competitive approach of thinking and implementing when it comes to studies and work.
								</p>
								<p>
									I graduated from{" "}
									...
									<a href="https://en.wikipedia.org/wiki/Actuarial_science" target="_blank" rel="noopener noreferrer">
										Actuarial Science
									</a>{" "}
									and for the past 3 years, I have been a team player and team leader providing solutions with the theory and
									methods learnt during internships and volunteering.
								</p>
								<p>
									I consider myself a forever student eager to build on her academic foundations in actuarial science and{" "}
									<a href="https://en.wikipedia.org/wiki/Statistical_finance" target="_blank" rel="noopener noreferrer">
										statistical finance
									</a>{" "}
									and stay in tune with evolving knowledge in both subjects through continuous professionalism.
								</p>
