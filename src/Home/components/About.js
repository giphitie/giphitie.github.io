 ...
 * @Last Modified time: 2020-11-06 22:19:01
...
const About = () => {
    ...
    return (
        <section
            className="giphitie-about img giphitie-section giphitie-no-pb"
            id="about-section"
        >
                    ...
                    <div className="col-md-6 col-lg-7 pl-lg-5 pb-5">
                        <div className="row justify-content-start pb-3">
                            ...
                            >
                                ...
                                <p>
                                    I am a student with experience in teaching
                                    and programming based in Kumasi. My
                                    background in programming inform my mindful
                                    but competitive approach of thinking and
                                    implementing when it comes to studies and
                                    work.
                                </p>
                                <p>
                                    I graduated from{" "}
                                ...
                                <p>
                                    ...
                                    and stay in tune with evolving knowledge in
                                    both subjects through continuous
                                    professionalism.
                                </p>
                                <ul className="about-info mt-4 px-md-0 px-2">
                                    <li className="d-flex">
                                        <span>Name:</span>{" "}
                                        <span>Gifty Osei</span>
                                    </li>
                                    ...
                                    <li className="d-flex">
                                        <span>Email:</span>{" "}
                                        <span>gifty18osei@gmail.com</span>
                                    </li>
                                    <li className="d-flex">
                                        <span>Phone: </span>{" "}
