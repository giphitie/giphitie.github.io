 ...
 * @Date: 2020-06-08 20:17:33
 * @Last Modified by:   Dieu-Donne Nazzah
 * @Last Modified time: 2020-06-08 20:17:33
 */

const Blog = () => {
	return {
		/* <!-- <section className="giphitie-section" id="blog-section">
				...
				<div className="row d-flex">
					<div className="col-md-4 d-flex ">
						<div className="blog-entry justify-content-end">
							<a href="single.html" className="block-20" style="background-image: url('images/bg_1.jpg');"> </a>
